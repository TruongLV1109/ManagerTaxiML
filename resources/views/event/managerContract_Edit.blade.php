    ...
    <div class="row">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input class="form-control" name="ContractNo" type="text" value="{{$contract->ContractNo}}">
                </div>
              </div> <!-- end form-group -->
               <div class="form-group d-n">
                <label class="col-sm-12 d-b c-red control-label" for="">Số hợp đồng</label>
                <div class="col-sm-12">
                  <input class="form-control" name="ContractSeq" type="text" value="{{$contract->ContractSeq}}">
                </div>
              </div> <!-- end form-group -->
             <div class="form-group">
              <div class="col-sm-12">
                ...
                <select class="form-control" id="IdContractType" name="IdContractType">
                  ...
                  <option value="{{$contractType['id']}}" @if( $contract->IdContractType == $contractType['id']){{'selected'}}@endif>{{$contractType['ContractTypeName']}}</option>
                  @endforeach
                </select>
              </div>
            </div> <!-- end form-group -->
            ...
            <div class="col-sm-6">
              <div class="form-group">
                ...
                <div class="col-sm-12">
                  <input class="form-control" name="ContractName" type="text" value="{{$contract->ContractName}}">
                </div>
              </div> <!-- end form-group --> 
              <div class="form-group">
                <label class="col-sm-12 d-b c-red control-label" for="">Ngày hiệu lực</label>
                <div class="col-sm-12"><input class="form-control datepicker-here" name="FrDate" type="text" data-language='en' value="{{$contract->FrDate}}"></div>
              </div> <!-- end form-group -->
             </div>
        </div>
        <div class="row">
          <div class="col-sm-8">
           <div class="form-group">
            ...
            <div class="col-sm-12">
              <textarea class="form-control" name="Notes" data-maxlength="500" cols="100" rows="8" style="height: 211px;width: 160%;">{{$contract->Notes}}</textarea>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-sm-4">
         <div class="form-group">
              ...
              <div class="col-sm-12">
                <input class="form-control" name="IdDriver" type="text" value="{{$contract->DriverNo}}">
              </div>
          </div> <!-- end form-group --> 
          <div class="form-group vi-h" id="ExDate">
            <label class="col-sm-12 d-b c-red control-label" for="">Hết hiệu lực</label>
            <div class="col-sm-12"><input class="form-control datepicker-here" id="inExDate" name="ExDate" type="text" data-language='en' value="{{$contract->ExDate}}"></div>
          </div> <!-- end form-group -->
...
<script> 
$(function(){
  if($("#IdContractType").find('option:selected').val() == 1){
